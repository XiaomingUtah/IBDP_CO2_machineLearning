...
axs[1,1].set_ylim(-0.06, 0.)
axs[1,1].yaxis.set_ticks([-0.04, -0.02, 0.00, 0.02])
axs[1,1].set_yticklabels([-0.04, -0.02, 0.00, 0.02])
...
axs[1].yaxis.set_ticks([-0.04, -0.02, 0.00, 0.02])
axs[1].set_yticklabels([-0.04, -0.02, 0.00, 0.02])
